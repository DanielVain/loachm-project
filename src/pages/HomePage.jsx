...
export default function HomePage() {
    ...
    // First paint needs only the small site-content payload (baked into the
    // HTML by the build-time prerender, so this is usually already true). The
    // board loads separately — DealsGrid shows its own skeleton — and the hero
    // image fades into its reserved frame.
    const showSkeleton = !siteReady;
